...
INSERT INTO `t_account` VALUES (1,1,1000,60,1048);
...
-- Dump completed on 2021-07-24 21:36:43
-- MySQL dump 10.13  Distrib 8.0.22, for Win64 (x86_64)
--
...
-- Dump completed on 2021-07-24 21:36:44
-- MySQL dump 10.13  Distrib 8.0.22, for Win64 (x86_64)
--
...
CREATE TABLE `t_order` (
  ...
  `status` tinyint(3) DEFAULT NULL COMMENT '订单状态: 0:创建中; 1:已完结',
  PRIMARY KEY (`id`)
...
INSERT INTO `t_order` VALUES (4,1,1,1,10,1),(5,1,1,1,10,1),(10,1,1,1,10,1),(11,1,1,1,10,1),(12,1,1,1,10,1),(13,1,1,1,10,1);
...
-- Dump completed on 2021-07-24 21:36:45
-- MySQL dump 10.13  Distrib 8.0.22, for Win64 (x86_64)
--
...
CREATE TABLE `t_storage` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `product_id` bigint(20) unsigned DEFAULT NULL COMMENT '产品id',
  `total` decimal(10,0) DEFAULT NULL COMMENT '总库存',
  `used` decimal(10,0) DEFAULT NULL COMMENT '已用库存',
  `residue` decimal(10,0) DEFAULT NULL COMMENT '剩余库存',
  PRIMARY KEY (`id`)
...
INSERT INTO `t_storage` VALUES (1,1,100,6,94);
...
-- MySQL dump 10.13  Distrib 8.0.22, for Win64 (x86_64)
--
-- Host: localhost    Database: springcloud2020
-- ------------------------------------------------------
-- Server version	8.0.12
...
INSERT INTO `payment` VALUES (31,'尚硅谷111'),(32,'atguigu002'),(34,'atguigu002'),(35,'atguigu002');
...
-- Dump completed on 2021-07-24 21:36:46
